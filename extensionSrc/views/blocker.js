  ...
  render() {
    ...
    return (
      <div id="ycb-blocker">
          ...
          <h2>You'll be taken to {URL} in <CountdownTimer siteVisitCount={this.props.db[URL].count}/> seconds. In the meantime, do something productive, like cleaning your room!</h2>
      </div>
    );
  }
}